...
import { useBizInboxSurface } from "../business/components/BizInboxSurfaceUtils";
import { BIZKIT_PROJECT_NAME } from "../business/components/BizKitConstants";
import useCometRouteTracePolicy from "../hooks/useCometRouteTracePolicy";

// eslint-disable-next-line complexity
function useBusinessCometCurrentRouteName() {
  const routeTracePolicy = useCometRouteTracePolicy();
  console.log(
    "🚀 ~ useBusinessCometCurrentRouteName ~ routeTracePolicy:",
    routeTracePolicy
  );
