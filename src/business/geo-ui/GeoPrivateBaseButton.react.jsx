...
const styles = {
  fullWidth: { width: "xh8yej3",  },
  container: { display: "x78zum5",  },
  hiddenButton: { display: "x1s85apg",  },
  growLabel: { flexGrow: "x1iyjqo2",  },
  icon: { flexShrink: "x2lah0s", flexGrow: "x1c4vz4f",  },
  iconEnd: {
...
const styles2 = {
  ...
  outlineOffset: { outlineOffset: "x1g40iwv",  },
  justifyCenter: { justifyContent: "xl56j7k",  },
  justifyStart: { justifyContent: "x1nhvcw1",  },
  grow: {
    display: "x78zum5",
    flexGrow: "x1iyjqo2",
    flexShrink: "xs83m0k",
  ...
  contentRoot: { justifyContent: "xl56j7k", opacity: "x1hc1fzr",  },
  contentHidden: { opacity: "xg01cxk",  },
  spinnerRoot: {
    display: 0,
    alignSelf: "xamitd3",
