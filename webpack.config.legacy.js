...
const options = {
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      template: path.join(__dirname, "public", "index.html"),
      minify: envv.NODE_ENV === "production",
      hash: envv.NODE_ENV === "production",
      cache: envv.NODE_ENV === "production",
      showErrors: envv.NODE_ENV === "development",
    }),
    new MiniCssExtractPlugin(),
    rsdPlugin,
    // Ensure that the stylex plugin is used before Babel
